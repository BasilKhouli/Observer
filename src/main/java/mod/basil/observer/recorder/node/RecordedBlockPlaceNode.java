...
public class RecordedBlockPlaceNode extends RecordedBlockNode {

    public RecordedBlockPlaceNode(final Level level, final int entityID, final BlockPos position, final Block block, final BlockState blockState) {
